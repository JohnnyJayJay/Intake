...
public final class ImmutableDescription implements Description {
  ...
  private ImmutableDescription(List<Parameter> parameters, List<String> permissions,
      String shortDescription, String help, @Nullable String usageOverride) {
  ...
  public static class Builder {
    ...
    public ImmutableDescription build() {
      return new ImmutableDescription(parameters, permissions, shortDescription, help,
          usageOverride);
    }
  }
