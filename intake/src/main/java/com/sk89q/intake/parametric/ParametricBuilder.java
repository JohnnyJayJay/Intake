...
public class ParametricBuilder {
   ...
   */
  public void registerMethodsAsCommands(Dispatcher dispatcher, Object object)
  ...
  /**
   * Get the default command suggestions provider that will be used if no suggestions are
   * available.
   *
  ...
  /**
   * Set the default command suggestions provider that will be used if no suggestions are
   * available.
   *
