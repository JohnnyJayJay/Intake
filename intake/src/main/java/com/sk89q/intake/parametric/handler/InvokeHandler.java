 ...
 * execution and can view the annotations, parameters, and arguments of the command. An invoke
 * handler could be used to implement command logging, for example.</p>
 */
public interface InvokeHandler {
   ...
   */
  boolean preProcess(List<? extends Annotation> annotations, ArgumentParser parser,
   ...
   * @throws ArgumentException Thrown is there is an error with the arguments
   */
  boolean preInvoke(List<? extends Annotation> annotations, ArgumentParser parser, Object[] args,
      CommandArgs commandArgs) throws CommandException, ArgumentException;
   ...
   * @throws ArgumentException Thrown is there is an error with the arguments
   */
  void postInvoke(List<? extends Annotation> annotations, ArgumentParser parser, Object[] args,
      CommandArgs commandArgs) throws CommandException, ArgumentException;
