 ...
 * domain-specific exceptions without having to worry with printing helpful error messages to the
 * user as a registered instance of this class will perform that job.</p>
 */
