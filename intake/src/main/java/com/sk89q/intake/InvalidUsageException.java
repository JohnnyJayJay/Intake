 ...
 * Print a one line help instruction unless {@link #isFullHelpSuggested()} is true, which, in that
 * case, the full help of the command should be shown.</p>
 *
...
public class InvalidUsageException extends CommandException {
   ...
   */
  public InvalidUsageException(@Nullable String message, CommandCallable command,
      List<String> aliasStack, boolean fullHelpSuggested) {
   ...
   */
  public InvalidUsageException(@Nullable String message, CommandCallable command,
      List<String> aliasStack, boolean fullHelpSuggested, @Nullable Throwable cause) {
    super(message, cause);
   ...
   * was raised, then the aliases list would consist of {@code [party, add]}.</p>
   *
